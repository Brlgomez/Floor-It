...
public class AllBlockNames : MonoBehaviour {
	...
	public static string[] blocksToBeAdded = {
		pointBlock, flyBlock, invisibleBlock, sizeBlock, shuffleBlock, multiplierBlock, objectBlock
	};
	...
	public static string[] blocksThatCanBeDeactivated = {
		...
		decelerateBlock, superDecelerateBlock, multiplierBlock, chainBlock, flyBlock
	};
